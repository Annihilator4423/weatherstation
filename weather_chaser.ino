...
const char* WIFI_PWD = "BigFatPa$$w0rd";
...
String OPEN_WEATHER_MAP_APP_ID = "f747ac0ff460c76d95ceb67b931b2bf0";
/*
 ...
 */
String OPEN_WEATHER_MAP_LOCATION_ID = "4390555";
...
int value = LOW;
  ...
  Rvalue=(float)(Vvalue/2000.0)*4;      //Convert Voltage in 5v factor
  ...
  else if(Tvoltage>2 && Tvoltage<=2){
    client.println("Need Imediate recharge");
    }
  else if(Tvoltage>3 && Tvoltage<=3){
  ...
  time_t observationTimestamp = forecasts[12].observationTime;
  struct tm* timeInfo;
 ...
 // String a = "A=" + String(bmp.readAltitude(103000)) + " m";// insert pressure at sea level
  ...
  client.println("<br>");
  client.println("===================================================");
  client.println("Weather Information");
  client.println("===================================================");
  client.println("<br>");
  client.println("Current Weather: "); 
  client.println(currentWeather.description);
  client.println("<br>");
  client.println("Forecast: ");
  client.println(forecasts[12].iconMeteoCon);
  client.println("<br>");
  client.println(forecasts[12].temp, 0);
  client.println("<br>");
  client.println("BMP180:");
  client.println("<br>");
  //client.println("Temp: ");
